...
export default async function globalSetup() {
  ...
  try {
    ...
    // Verificar tablas críticas para las pruebas
    ...
    if (missingTables.length > 0) {
      ...
      console.log("🔄 Reintentando creación de schema...");

      // Forzar la recreación del schema
      ...
      console.log("✅ Schema forzado con db push");
      ...
      `;
      console.log(
        "📋 Tablas después de recrear:",
        newTables.map((t: { tablename: string }) => t.tablename).join(", "),
      );
    }
