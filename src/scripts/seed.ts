...
async function main() {
  ...
  for (const d of doctors) {
    ...
    if (specialty) {
      ...
      console.log(
        `  ✓ Doctor creado: ${d.firstName} ${d.lastName} (${d.specialty})`,
      );
    }
  }
  ...
  console.log(`  Admin:      admin@horavital.cl / ${defaultPassword}`);
  console.log(`  Secretaria: secretaria@horavital.cl / ${defaultPassword}`);
  console.log(`  Paciente:   paciente@horavital.cl / ${defaultPassword}`);
  console.log(
